...
const translations = {
  zh: {
    ...
    heroSubtitle: "<strong>給長輩、電腦小白與忙碌工作者的友善軟體入口</strong>，讓下載、使用、驗證都更安心。<span class='tagline'>用小工具降低摩擦，用每一次使用推動友善社會。</span>",
    ...
    productCardDescription:
      "一份給長輩、電腦小白與忙碌工作者的安全工具入口，降低設定摩擦，保留清楚來源與合規檢查。",
    ...
    productAudienceDoctor: "適合：長輩、電腦小白，或希望降低下載與設定風險的人。",
    ...
    downloadCheckAudienceValue: "長輩、電腦小白、忙碌工作者",
  ...
  en: {
    ...
    heroSubtitle: "<strong>A friendly software gateway for seniors, beginners, and busy workers</strong>, making download, use, and verification feel safer. <span class='tagline'>Reduce friction with small tools, then turn every use into a friendlier society.</span>",
    ...
    productCardDescription:
      "A safer software entry point for seniors, beginners, and busy workers, reducing setup friction while preserving source clarity and compliance checks.",
    ...
    productAudienceDoctor: "Good fit: seniors, beginners, or anyone who wants safer downloads and simpler setup.",
    ...
    downloadCheckAudienceValue: "Seniors, beginners, and busy workers",
